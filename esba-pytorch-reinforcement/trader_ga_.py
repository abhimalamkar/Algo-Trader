...
if __name__ == "__main__":
    ...
    while True:
        ...
        torch.save(net.state_dict(), '../models/01/%d_elite_net.model'%elite[1])

        save('../models/01/elite.data',elite)
        save('../models/01/population.data',population)
